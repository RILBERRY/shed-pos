<div class=" bg-white rounded-md w-full md:w-[90%] p-2 md:p-5 md:mx-auto ">
    <div class="flex md:flex-row flex-col  justify-between w-full mx-auto pb-2">
        <h3 class=" p-2 my-auto text-2xl text-gray-500">QUOTATIONS</h3>
        <div class="flex gap-2 ">
            ...
            <button wire:click="$dispatch('openModal', { component: 'create-quotation' })" class="p-2 bg-blue-600 my-auto  rounded-md text-white">Create</button>
        </div>
    </div>
